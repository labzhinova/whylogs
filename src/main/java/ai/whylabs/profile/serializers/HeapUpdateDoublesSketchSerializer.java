...
public class HeapUpdateDoublesSketchSerializer extends ClassTaggedSerializer<UpdateDoublesSketch> {
  ...
  @Override
  public UpdateDoublesSketch read(Kryo kryo, Input input,
      Class<? extends UpdateDoublesSketch> type) {
    helper.checkAndRegister(kryo);
  ...
  public Class<?> getClassTag() {
    try {
      ...
      return Class.forName("org.apache.datasketches.quantiles.HeapUpdateDoublesSketch");
